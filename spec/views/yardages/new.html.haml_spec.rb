...
describe "yardages/new.html.haml" do
  before(:each) do
    assign(:yardage, stub_model(Yardage,
      :title => "MyString",
      :description => "MyText",
      :length => 1.5,
      :width => 1.5,
  ...
  it "renders new yardage form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => yardages_path, :method => "post" do
